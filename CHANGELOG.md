...
## [Unreleased](https://git.d3data.de/D3Public/oxid_twig_extensions/compare/1.4.0.1...rel_1.x)

## [1.4.0.1](https://git.d3data.de/D3Public/oxid_twig_extensions/compare/1.4.0.0...1.4.0.1) - 2026-06-26
### Fixed
- prevent type error in exception case

## [1.4.0.0](https://git.d3data.de/D3Public/oxid_twig_extensions/compare/1.3.0.0...1.4.0.0) - 2026-02-02
### Added
- add instanceOf extension
